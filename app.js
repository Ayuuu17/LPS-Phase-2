...
const STORE_KEY = "lps_phase2_requirements_final_state_v2";
const SESSION_KEY = "lps_phase2_requirements_final_session_v2";
    ...
    <div class="public-shell">
      <section class="hero">
        <div>
          ...
          <p class="footer-note">Customers register from this screen. Administrators use the single fixed admin account provided in the README.</p>
        </div>
        <div class="auth-card">
...
function renderLoginForm(){
  return `<form class="form-grid" onsubmit="handleLogin(event)" novalidate>
    <div class="notice">Log in with your email and password. Customer accounts require two-step verification after credentials are accepted.</div>
